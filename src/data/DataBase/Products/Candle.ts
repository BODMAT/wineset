import { Candle } from "../../OOPStructure/Pruduct";
...
const C1 = new Candle({
    ...
    price: 5,
    weight: 0.3,
    imageUrl: "/Products/Candles/LavenderSerenity.png",
    country: "France",
    quantity: 800,
    fullDescription: {
        region: "Provence",
...
const C2 = new Candle({
    ...
    price: 6,
    weight: 0.45,
    imageUrl: "/Products/Candles/VanillaBliss.png",
    country: "Madagascar",
    quantity: 700,
    discount: 15,
    fullDescription: {
...
const C3 = new Candle({
    ...
    price: 7,
    weight: 0.4,
    imageUrl: "/Products/Candles/CitrusEnergy.png",
    country: "Italy",
    quantity: 600,
    discount: 10,
    fullDescription: {
...
const C4 = new Candle({
    ...
    price: 8,
    weight: 0.55,
    imageUrl: "/Products/Candles/ForestWhisper.png",
    country: "Canada",
    quantity: 500,
    discount: 10,
    fullDescription: {
...
const C5 = new Candle({
    ...
    weight: 0.48,
    discount: 10,
    imageUrl: "/Products/Candles/RoseHarmony.png",
    country: "Bulgaria",
    quantity: 650,
    fullDescription: {
