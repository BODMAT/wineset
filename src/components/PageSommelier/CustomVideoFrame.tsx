...
export function CustomVideoFrame() {
    return (
        <motion.section initial={"hidden"}
            ...
            className="myContainer pb-18 max-sm:pb-12">
            <div className="flex gap-10 justify-between items-center max-[920px]:flex-col">
                <div className="flex flex-col gap-4">
                    <motion.h2 variants={textFromTopAnimation} className="text-[#121212] not-italic font-[Cormorant] font-bold uppercase !text-[48px] max-[400px]:!text-[36px] max-sm:text-center pl-4">The Art of Wine Presentation</motion.h2>
